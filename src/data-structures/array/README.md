...
## Задачки
1. [Сортировка массива методом пузырька](bubbleSort.js)
2. [Сортировка массива](sort.js)
3. [Сортировка по частоте](sortByFrequency.js)
4. [Найти пару чисел с заданной суммой](findAllUniquePairs.js)
5. [Найти среднее значение](findAverage.js)
6. [Найти пропущенное число](findMissingNumber.js)
7. [Найти два числа, сумма которых равна заданному значению](findTwoSum.js)
8. [Поиск максимального и минимального значения](findMaxAndMin.js)
9. [Конкатенация двух массивов](concat.js)
10. [Проверка на палиндром](isPalindrome.js)
11. [Расстановка элементов](rearrangeArray.js)
12. [Удаление дубликатов](removeDuplicates.js)
13. [Разворот массива](reverse.js)
14. [Сумма двух массивов](sumArrays.js)
...
## Ресурсы
- О массивах - https://youtu.be/47_LhSf-ago?si=YU_ma_q63EpT78fe
